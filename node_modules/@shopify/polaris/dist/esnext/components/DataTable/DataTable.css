...
.Polaris-DataTable__TableRow_1a85o + .Polaris-DataTable__TableRow_1a85o .Polaris-DataTable__Cell_yixs7{ border-top:0.1rem solid var(--p-divider, #dfe3e8); }

.Polaris-DataTable__Cell_yixs7{ padding:1.6rem; white-space:nowrap; text-align:left; transition:background-color 0.2s ease-in-out; }
...
.Polaris-DataTable__Heading_1brcv:hover{ color:var(--p-interactive-hovered, #5c6ac4); }

.Polaris-DataTable__Heading_1brcv:hover svg{ fill:var(--p-interactive-hovered, #5c6ac4); }

.Polaris-DataTable__Heading_1brcv:hover .Polaris-DataTable__Icon_yj27d{ opacity:1; }

.Polaris-DataTable__Heading_1brcv:focus:not(:active)::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }

@media (-ms-high-contrast: active){ .Polaris-DataTable__Heading_1brcv:focus:not(:active)::after{ outline:1px solid windowText; } }
...
.Polaris-DataTable--cellTotalFooter_1fqr9{ border-top:0.1rem solid var(--p-divider, #dfe3e8); border-bottom:none; border-bottom-left-radius:var(--p-border-radius-base, 3px); border-bottom-right-radius:var(--p-border-radius-base, 3px); }

.Polaris-DataTable__Footer_z4ij5{ padding:1.6rem; background:var(--p-surface-subdued, #f4f6f8); color:var(--p-text-subdued, #637381); text-align:center; border-top:0.1rem solid var(--p-divider, #dfe3e8); border-bottom-left-radius:var(--p-border-radius-base, 3px); border-bottom-right-radius:var(--p-border-radius-base, 3px); }
