...
function Badge({
  ...
  let accessibilityMarkup = (progressLabel || statusLabel) && /*#__PURE__*/React__default.createElement(VisuallyHidden, null, accessibilityLabel);
...
var styles$a = {
  ...
  "stretchContent": "Polaris-Button--stretchContent",
...
function Section$2({
  ...
  const className = classNames(styles$e.Section, flush && styles$e['Section-flush'], subdued && styles$e['Section-subdued'], fullWidth && styles$e['Section-fullWidth']);
  const actionMarkup = actions ? /*#__PURE__*/React__default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
